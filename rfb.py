...
class RFB(object):
    ...
    def generate(self):
        ...
        #   载入模型与权值
        #-------------------------------#
        self.rfb = RFB300([self.input_shape[0], self.input_shape[1], 3], self.num_classes)
        self.rfb.load_weights(self.model_path, by_name=True)
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        preds      = self.rfb.predict(image_data)
        #-----------------------------------------------------------#
        #   将预测结果进行解码
        #-----------------------------------------------------------#
